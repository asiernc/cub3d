...
/*   Updated: 2024/07/29 12:12:44 by molasz-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_right(t_player_mlx *player, char **map)
{
	...
	x = (player->pos.x + player->plane.x * MOVE_SPEED) / TILE_SIZE + 0.2;
	y = (player->pos.y + player->plane.y * MOVE_SPEED) / TILE_SIZE + 0.2;
	nx = (player->pos.x + player->plane.x * MOVE_SPEED) / TILE_SIZE - 0.2;
	ny = (player->pos.y + player->plane.y * MOVE_SPEED) / TILE_SIZE - 0.2;
	if (map[player->pos.y / TILE_SIZE][x] == '0'
			&& map[player->pos.y / TILE_SIZE][nx] == '0')
